...
import { ArrowRight, Play, Sparkles, Users, Award, TrendingUp, Clock } from 'lucide-react';
...
const HeroSection = () => {
  ...
  const words = ['social media', 'brand story', 'content strategy', 'audience growth'];
    ...
    <>
      <section className="relative min-h-screen flex items-center bg-gradient-to-br from-slate-50 via-white to-blue-50 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-blue-100/30 rounded-full blur-3xl animate-float" style={{animationDelay: '1s'}}></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-indigo-100/20 rounded-full blur-3xl animate-float" style={{animationDelay: '2s'}}></div>
        </div>
        ...
        >
          <div className="text-center">
            ...
            >
              ...
              >
                Get a personalized content calendar in minutes, then let our team handle all content creation to bring your strategy to life.
              </motion.span>
            </motion.p>
            ...
            >
              ...
              >
                <Sparkles size={20} />
                <span>{user ? 'Go to Dashboard' : 'Create My Content Calendar'}</span>
                <motion.div
            ...
            >
              ...
              >
                {logos.map((logo, index) => (
                  ...
                  >
                    <img src={logo.src} alt={logo.alt} className="h-full w-full object-contain grayscale hover:grayscale-0 transition-all duration-200" />
                  </motion.div>
                ))}
              </motion.div>
            </motion.div>
