    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <SectionHeader
          badge={
            <>
              <Video size={16} className="mr-2" /> Videography Services
            </>
          }
          title={
            <>
              Professional <span className="gradient-text">Videography</span>{" "}
              Services
            </>
          }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Creative and engaging music video production for artists
                      and bands.
                    </p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Professional video documentation of corporate events,
                ...
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Engaging promotional videos for businesses, products, and
                      services.
                    </p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Dynamic highlight videos for sports events, performances,
                      and special moments.
                    </p>
                  </div>
                </li>
          ...
          <div className="space-y-8">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Expert guidance in storytelling and visual composition.
                    </p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Polished post-production with attention to detail and
                      creative effects.
                    </p>
                  </div>
                </li>
                <li className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Tailored video production packages to meet your specific
                      needs and vision.
                    </p>
                  </div>
                </li>
            ...
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 text-white">
              ...
              <p className="mb-6">
                Let's discuss your videography needs and create something
                amazing together.
              </p>
              <button
