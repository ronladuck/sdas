...
import { Camera, ArrowRight, Play, Award, Users, Zap, Star, Sparkles } from 'lucide-react';
  ...
  const testimonials = [
    {
      ...
      image: "https://images.unsplash.com/photo-1494790108755-2616b332765c?w=80&h=80&fit=crop&crop=face",
      ...
      <div className="relative h-screen overflow-hidden">
        <div 
          ...
          style={{
            ...
            animation: 'backgroundMove 20s ease-in-out infinite alternate, backgroundZoom 15s ease-in-out infinite alternate',
          }}
        >
          ...
          <div className="text-center animate-fade-in-up">
            <div className="flex items-center justify-center mb-6">
              <div className="bg-purple-600/20 backdrop-blur-sm px-4 py-2 rounded-full border border-purple-400/30">
                ...
                <span className="text-purple-300 font-medium tracking-wide">PROFESSIONAL PHOTOGRAPHY</span>
              </div>
            </div>
            ...
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
              Your story deserves to be captured beautifully. Let us bring it to life with skill and passion.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in-up">
            <div className="inline-flex items-center bg-gradient-to-r from-purple-100 to-pink-100 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-purple-700 font-medium">Award-Winning Portfolio</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              Our <span className="gradient-text">Masterpieces</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              A curated selection of our finest work across different styles and genres
            </p>
          </div>
            ...
            <div className="relative group cursor-pointer">
              <div className="relative h-96 md:h-[500px] overflow-hidden rounded-lg">
                ...
                <div className="absolute bottom-8 left-8 text-white">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold">{portfolioImages[0].title}</h3>
                </div>
              </div>
            </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="animate-pulse-soft">
              <div className="text-5xl md:text-7xl font-bold mb-2 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">10k+</div>
              <div className="text-gray-300 font-medium">Content Pieces Created</div>
            </div>
            <div className="animate-pulse-soft stagger-1">
              <div className="text-5xl md:text-7xl font-bold mb-2 bg-gradient-to-r from-pink-400 to-yellow-400 bg-clip-text text-transparent">500+</div>
              <div className="text-gray-300 font-medium">Happy Clients</div>
            </div>
            <div className="animate-pulse-soft stagger-2">
              <div className="text-5xl md:text-7xl font-bold mb-2 bg-gradient-to-r from-yellow-400 to-purple-400 bg-clip-text text-transparent">24/7</div>
              <div className="text-gray-300 font-medium">AI-Powered Support</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-20 bg-gradient-to-br from-purple-600 via-pink-600 to-purple-700 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Let's bring your vision to life with professional photography that tells your unique story and captivates your audience.
          </p>
          <div className="flex justify-center">
            <button
              onClick={handleGetStarted}
          ...
          <div className="mt-8 text-center">
            <p className="text-white/70 text-sm">
              🎯 Free consultation included • 📸 Same-day booking available • ⭐ 100% satisfaction guaranteed
            </p>
          </div>
        </div>
      </div>
