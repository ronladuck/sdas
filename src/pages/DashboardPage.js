...
const DashboardPage = () => {
  ...
  const generateMockPosts = (formData) => {
    ...
    for (let i = 0; i < 30; i++) {
      const randomType = postTypes[Math.floor(Math.random() * postTypes.length)] || 'Educational Posts';
      posts.push({
        id: i + 1,
    ...
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 text-white">
        ...
        <p className="text-xl opacity-90 mb-6">
          Ready to create amazing content? Let's build your next content calendar.
        </p>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Total Calendars</h3>
              <p className="text-3xl font-bold text-purple-600">{contentCalendars.length}</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-3xl font-bold text-blue-600">
                {contentCalendars.reduce((total, calendar) => total + calendar.posts.length, 0)}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-3xl font-bold text-green-600">
                {contentCalendars.length > 0 ? contentCalendars[contentCalendars.length - 1].posts.length : 0}
              </p>
            </div>
          </div>
        </div>
      ...
      {contentCalendars.length > 0 && (
        <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">Recent Calendars</h3>
          <div className="space-y-4">
            {contentCalendars.slice(-3).map((calendar) => (
              <div key={calendar.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div>
                  <h4 className="font-semibold text-gray-900">{calendar.businessName}</h4>
                  <p className="text-sm text-gray-600">{calendar.industry} • {calendar.posts.length} posts</p>
                </div>
  ...
  const renderCalendars = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-gray-900">Your Content Calendars</h2>
        <button
          onClick={() => setActiveTab('create')}
      ...
      {contentCalendars.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">No calendars yet</h3>
          <p className="text-gray-600 mb-6">Create your first AI-powered content calendar to get started.</p>
          <button
            onClick={() => setActiveTab('create')}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {contentCalendars.map((calendar) => (
            <div key={calendar.id} className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-semibold text-gray-900">{calendar.businessName}</h3>
              ...
              <div className="flex items-center justify-between mb-4">
                <span className="text-sm text-gray-600">{calendar.posts.length} posts generated</span>
                <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">Active</span>
              </div>
              
              <div className="space-y-2 mb-4">
                {calendar.posts.slice(0, 3).map((post) => (
                  <div key={post.id} className="text-sm text-gray-600 bg-gray-50 p-2 rounded">
      ...
      <div className="text-center mb-8">
        {contentCalendars.length === 0 ? (
          <>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Welcome! Let's Create Your First Content Calendar</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-4">
              Tell us about your business and we'll generate a personalized 30-day content calendar with engaging posts, captions, and optimal posting times.
            </p>
            <p className="text-lg text-purple-600 font-semibold">
              After we create your calendar, Mark will reach out within 24 hours to help you get started! 🚀
            </p>
          </>
        ) : (
          <>
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Create New Content Calendar</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our AI will analyze your business information and create a personalized 30-day content calendar 
              with engaging posts, captions, and optimal posting times.
            </p>
          </>
        )}
      </div>

      <ContentCalendarForm onSubmit={handleFormSubmit} isLoading={isGenerating} />
    </div>
  );
  ...
  const renderSuccess = () => (
    <div className="max-w-3xl mx-auto">
      <div className="text-center mb-8">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-4">🎉 Your Content Calendar is Ready!</h2>
        <p className="text-xl text-gray-600 mb-8">
          We've generated a personalized 30-day content calendar for <strong>{latestCalendar?.businessName}</strong>
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100 mb-8">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-semibold text-gray-900">Your Content Calendar</h3>
          ...
          {latestCalendar?.posts.slice(0, 4).map((post, index) => (
            <div key={post.id} className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-purple-600">{post.type}</span>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-8 border border-blue-100">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-700 mb-6">
            <strong>Mark@StopDropScroll.co</strong> will be reaching out to you within the next <strong>24 hours</strong> to discuss your content strategy and help you implement your new calendar.
          </p>
          <div className="bg-white rounded-lg p-6 mb-6">
            <h4 className="font-semibold text-gray-900 mb-3">During our call, we'll cover:</h4>
            <ul className="text-left space-y-2 text-gray-700">
              <li className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span>Customizing your content calendar to perfectly match your brand</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span>Setting up your content creation and posting workflow</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span>Discussing additional services like photography and videography</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold gradient-text">Content Calendar AI</h1>
            </div>
      ...
      <nav className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex space-x-8">
            ...
            ].filter(tab => activeTab !== 'success' || tab.id !== 'create').map((tab) => (
              <button
                key={tab.id}
